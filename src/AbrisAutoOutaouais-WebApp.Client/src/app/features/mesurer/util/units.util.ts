 ...
 * `footprint.util`, dimensions véhicules, paramètres de l'endpoint D2 `suggest-shelters`,
 * DTO produit) raisonne en cm. Les **pieds ne servent QU'À l'AFFICHAGE et à la SAISIE** —
