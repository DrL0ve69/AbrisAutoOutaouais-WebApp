...
namespace AbrisAutoOutaouais_WebApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260619140029_AddOrderLineShelterConfig")]
    partial class AddOrderLineShelterConfig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AbrisAutoOutaouais_WebApp.Domain.Entities.ShelterModel", b =>
                {
                    ...
                    b.OwnsMany("AbrisAutoOutaouais_WebApp.Domain.Entities.ShelterModelDimension", "Dimensions", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<Guid>("ShelterModelId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("ValueCm")
                                .HasColumnType("int");

                            b1.HasKey("Id");

                            b1.HasIndex("ShelterModelId");

                            b1.ToTable("ShelterModelDimension");
