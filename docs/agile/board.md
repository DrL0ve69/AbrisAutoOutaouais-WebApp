...
| EPIC 7 | Paiements (Interac e-Transfer + cartes) | 1 | — | 21+ | Could | ✅ **MERGÉ (2026-06-23, PR #__)** — 7.0→7.4 livrés (e-Transfer 3 flux + stubs keyless + doc webhook), revue de fin d'épic APPROVE WITH NITS. **EPIC 7 = dernière épopée Phase 2 → Phase 2 TERMINÉE.** |
...
Branche `feat/epic-7-paiement-etransfer` → PR #__ → merge `master`.
